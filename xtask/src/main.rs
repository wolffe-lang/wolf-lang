...
fn main() -> ExitCode {
    ...
    match args.first().map(String::as_str) {
        ...
        _ => {
            eprintln!(
                "usage: cargo xtask <ci|deps-check|corpus|bench|fuzz-smoke|fmt-fuzz|dist|spec-extract|conformance|differ|print-gate|diag-catalog|doc-catalog|fmt-lu|audit-surface|midend-rate>"
            );
