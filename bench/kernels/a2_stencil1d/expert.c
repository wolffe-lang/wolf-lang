/* a2-stencil1d (family A), EXPERT C: the same stencil with hand-written
 * `restrict` — the disjointness fact wolf proves from param modes.
...
static void stencil(int64_t *restrict out, const int64_t *restrict src) {
    for (int i = 1; i < N - 1; i++)
